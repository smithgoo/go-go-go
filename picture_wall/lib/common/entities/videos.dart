class VideosListResponseEntity {
  int? page;
  int? size;
  int? total;
  List<Videos>? videos;

  VideosListResponseEntity({this.page, this.size, this.total, this.videos});

  VideosListResponseEntity.fromJson(Map<String, dynamic> json) {
    page = json['page'];
    size = json['size'];
    total = json['total'];
    if (json['videos'] != null) {
