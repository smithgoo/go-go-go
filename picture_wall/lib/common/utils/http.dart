    ...
    dio.interceptors.add(InterceptorsWrapper(
      ...
      onError: (DioException e, handler) {
        ...
        if (eInfo.code == 401) {
          ...
          Get.snackbar("message", "登录失败或token失效");
        } else {
          // 尝试将响应数据转换成 JSON 格式
          if (e.response != null) {
            Map<String, dynamic> responseData =
